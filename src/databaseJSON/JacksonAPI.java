...
public class JacksonAPI {
	...
	public static LinkedHashMap<String, Object> pullFromOMDB(String movieName, int type, JFrame frame) throws 
	JsonParseException, IOException, ClassNotFoundException, InstantiationException, 
